...
def add_remap(
    ...
    """Remap using the weights mapping.
    
    This allows for an easy dot product calculation.
    """
    ...
    A = np.zeros((out_len, len(remapped_values)))
    A[w_mapping["output_indexes"], w_mapping["inv_indexes"]] = w_mapping["weights"]
