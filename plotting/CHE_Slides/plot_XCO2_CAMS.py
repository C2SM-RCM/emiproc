...
folder = "/store/empa/em05/dbrunner/che/columns/column_gvri_"
...
for i in range(1,10):
    for j in range(0,24,3):
        ...
        plt.tight_layout()
        plt.title("XCO2 signal (in ppm) on %s" %date_disp)
        ...
        plt.savefig("Figures/XCO2_cams_"+date_str+".png")
        plt.clf()
        #plt.show()
