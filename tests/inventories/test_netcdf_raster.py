...
class TestGetUnitScalingFactor:
    """Tests for the get_unit_scaling_factor_to_kg_per_year_per_cell function."""

    def test_kg_per_m2_per_s(self):
    ...
    def test_kg_per_year_per_cell(self):
...
class TestGetYearFromAttrs:
    """Tests for the get_year_from_attrs function."""
...
# Test NetcdfRaster class


class TestNetcdfRasterBasic:
    """Basic tests for the NetcdfRaster class."""

    def test_read_simple_netcdf(self, simple_netcdf_file):
...
class TestNetcdfRasterWithManualMapping:
    ...
    def test_missing_variable_raises_error(self, simple_netcdf_file):
...
class TestNetcdfRasterUnitConversion:
    """Tests for unit conversion in NetcdfRaster."""

    def test_unit_override(self, netcdf_file_no_unit_attr):
    ...
    def test_missing_unit_raises_error(self, netcdf_file_no_unit_attr):
...
class TestNetcdfRasterTime:
    """Tests for time dimension handling in NetcdfRaster."""

    def test_single_time_step(self, netcdf_file_with_time):
    ...
    def test_multiple_time_steps_requires_profile(
        self, netcdf_file_with_monthly_profiles
    ):
    ...
    def test_monthly_profiles(self, netcdf_file_with_monthly_profiles):
    ...
    def test_year_override(self, simple_netcdf_file):
...
class TestNetcdfRasterErrorHandling:
    """Tests for error handling in NetcdfRaster."""

    def test_no_catsub_no_mapping_raises_error(self, netcdf_file_no_catsub_attrs):
...
class TestNetcdfRasterGrid:
    """Tests for grid handling in NetcdfRaster."""

    def test_grid_created_correctly(self, simple_netcdf_file):
