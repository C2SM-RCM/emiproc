...
#%% Load the icon grid
grid_file = Path(
    r"C:\Users\coli\Documents\ZH-CH-emission\icon_europe_DOM01.nc"
)
...
#%%
remaped_tno = remap_inventory(inv, icon_grid, grid_file.parent / f"remap_tno2{grid_file.stem}")
#%%

explore_inventory(remaped_tno, 'A', 'CO2')
# %%
explore_multilevel(remaped_tno.gdf.to_crs(WGS84).loc[::3], ('A', 'CO2'), logscale=True)
# %%
...
export_icon_oem(remaped_tno, grid_file, grid_file.with_stem(f"{grid_file.stem}_with_tno_emissions.nc"))
# %%
