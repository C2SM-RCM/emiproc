...
gnfr = [ "A", "B", "C", "D", "E", "F", 
        "G", "H", "I", "J", "K", "L" ]
edgar_cat = [ "AGS", "CHE", "ENE", "FFF", "IND", "IRO","NEU","NFE","NMM", "PRO", "PRU_SOL", "RCO", "REF_TRF", "SWD_INC", "TNR_Aviation_CDS", "TNR_Aviation_CRS", "TNR_Aviation_LTO","TNR_Other","TNR_Ship","TRO"]
year = 2015
gridname = 'Europe'
